    ...
    <div className="document-container">
      <form onSubmit={handleSubmit}>
        <table className="document-header">
          <tbody>
            <tr>
              <td colSpan="4" className="title">퇴직처리 요청서</td>
            </tr>
            <tr>
              <td>사원번호</td>
            ...
            <tr>
              <td>퇴직 사유</td>
              <td colSpan="3"><input type="text" name="rejection_reason" value={document.rejection_reason} onChange={handleChange} /></td>
            </tr>
          </tbody>
        </table>
